...
func (_m *UserStorer) Create(_a0 context.Context, _a1 *models.SignupReq) error {
...
func (_m *UserStorer) FindViaEmail(ctx context.Context, email string) (*models.UserModel, error) {
