...
func (_m *VitalsStorer) Create(ctx context.Context, req *dto.CreateVitalReq) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *dto.CreateVitalReq) error); ok {
		r0 = rf(ctx, req)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *VitalsStorer) Update(ctx context.Context, req *dto.UpdateVitalReq) error {
	ret := _m.Called(ctx, req)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *dto.UpdateVitalReq) error); ok {
		r0 = rf(ctx, req)
	} else {
		r0 = ret.Error(0)
	}
